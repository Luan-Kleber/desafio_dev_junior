...
for key, value in dados.items():
    for values in value:
        ...
        if valor < 100:
            print(f"Valor da venda R${valor:.2f}, Não será cobrado comissão.\n")
        elif valor > 100 and valor < 500:
            comissao = (1/100) * valor
            print(f"Valor da venda R${valor:.2f}, Será gerado comissão de 1% pela da venda R${comissao:.2f}\n")
        else:
            comissao = (5/100) * valor
            print(f"Valor da venda R${valor:.2f}, Será gerado comissão de 5% pela da venda R${comissao:.2f}\n")